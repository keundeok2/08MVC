	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<a href="/basket/addBasket?userId=${user.userId}&prodNo=${product.prodNo}">장바구니</a>
				</td>
				...
				<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
				<c:if test="${param.menu.equals('search') }">
					<a href="/purchase/addPurchase?prodNo=${product.prodNo}<%--= product.getProdNo() --%>">구매</a>
				</c:if>
				<c:if test="${param.menu.equals('manage') }">
					<a href="/product/listProduct?menu=${param.menu}<%--= menu --%>">확인</a>
				</c:if>
				</td>
				<td width="14" height="23">
					<img src="/images/ct_btnbg03.gif" width="14" height="23">
